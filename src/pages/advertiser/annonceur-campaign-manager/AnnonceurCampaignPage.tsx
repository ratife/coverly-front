...
const AnnonceurCampaignPage: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen overflow-hidden bg-slate-50 dark:bg-background-dark text-slate-800 dark:text-slate-100 font-display">
      {/* Sidebar */}
      <div className="w-64 bg-white dark:bg-card-dark border-r border-slate-200 dark:border-border-dark p-6">
        ...
        <nav className="space-y-2">
          ...
          <a href="#" className="flex items-center gap-3 p-3 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 text-slate-600 dark:text-slate-300">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-y-auto custom-scrollbar">
        ...
        <header className="sticky top-0 z-10 flex items-center justify-between px-8 py-4 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md border-b border-slate-200 dark:border-border-dark">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Gérez vos campagnes publicitaires en temps réel</p>
          </div>
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-card-dark rounded-2xl p-6 border border-slate-200 dark:border-border-dark">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <p className="text-sm text-slate-500 dark:text-slate-400">Total Dépensé</p>
            ...
            <div className="bg-white dark:bg-card-dark rounded-2xl p-6 border border-slate-200 dark:border-border-dark">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <p className="text-sm text-slate-500 dark:text-slate-400">Impressions Actives</p>
            ...
            <div className="bg-white dark:bg-card-dark rounded-2xl p-6 border border-slate-200 dark:border-border-dark">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <p className="text-sm text-slate-500 dark:text-slate-400">CTR Moyen</p>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-200 dark:border-border-dark">
                    <th className="text-left p-4 text-slate-500 dark:text-slate-400">Campagne</th>
                    <th className="text-left p-4 text-slate-500 dark:text-slate-400">Statut</th>
                    <th className="text-left p-4 text-slate-500 dark:text-slate-400">Budget</th>
                    <th className="text-left p-4 text-slate-500 dark:text-slate-400">Impressions</th>
                    <th className="text-left p-4 text-slate-500 dark:text-slate-400">CTR</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={idx} className="border-b border-slate-100 dark:border-border-dark/50 hover:bg-slate-50 dark:hover:bg-white/5">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            {/* Audience Metrics */}
            <div className="bg-white dark:bg-card-dark rounded-2xl p-6 border border-slate-200 dark:border-border-dark xl:col-span-2">
              <h3 className="text-xl font-bold mb-6">Métriques d'Audience</h3>
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">Âge moyen</p>
                  <p className="text-2xl font-bold">28 ans</p>
                </div>
                <div>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">Genre</p>
                  <p className="text-2xl font-bold">65% H / 35% F</p>
                </div>
                <div>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">Localisation</p>
                  <p className="text-2xl font-bold">France</p>
                </div>
                <div>
                  <p className="text-sm text-slate-500 dark:text-slate-400 mb-2">Engagement</p>
            ...
            <div className="bg-primary/10 rounded-2xl p-6 border border-primary/20 relative overflow-hidden flex flex-col justify-center">
              <div className="relative z-10">
                ...
                <h4 className="font-bold text-xl leading-tight text-slate-800 dark:text-white">Boostez votre visibilité</h4>
                <p className="text-slate-500 dark:text-slate-400 text-sm mt-2">Accédez aux placements premium sur les créateurs certifiés.</p>
